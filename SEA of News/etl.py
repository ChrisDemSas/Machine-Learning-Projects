...
def load(dataset: dict) -> None:
    ...
    #for item in dataset:
        #dataset[item].to_csv(f'/Users/chrissastropranoto/Desktop/MerdekaKiri/NewsScraperDatabase/dataset/{item}.csv', index = False)
    
    conn = sqlite3.connect('/Users/chrissastropranoto/Desktop/MerdekaKiri/news_dataset.db')
    c = conn.cursor()
